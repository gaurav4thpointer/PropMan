...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Dashboard: expected vs received, overdue, upcoming cheques, bounced count' }),
...
__decorate([
    (0, common_1.Get)('export/rent-schedule'),
    (0, swagger_1.ApiOperation)({ summary: 'Export rent schedule as CSV' }),
    (0, common_1.Header)('Content-Type', 'text/csv'),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __param(1, (0, common_1.Res)()),
    __param(2, (0, common_1.Query)('propertyId')),
